...
CREATE DATABASE IF NOT EXISTS DAW207DWESProyectoTema4;

-- CREAR Tabla Departamento dentro de la base de datos DAW207DBDepartamentos
CREATE TABLE IF NOT EXISTS DAW207DWESProyectoTema4.Departamento(
...
GRANT ALL PRIVILEGES ON User207DWESProyectoTema4.* to 'User207DWESProyectoTema4'@'%' WITH GRANT OPTION;